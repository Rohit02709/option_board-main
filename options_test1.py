...
try:
    ...
    with tab4:
        ...
        signal_table = oi_top_5[['CALLS_OI', 'CALLS_Chng_in_OI', 'CALLS_OI_Percent_Change', 'CALLS_LTP', 'PUTS_OI', 'PUTS_Chng_in_OI', 'PUTS_OI_Percent_Change', 'PUTS_OI', 'Signal']].style.applymap(
